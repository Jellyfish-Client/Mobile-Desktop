...
class _$BaseItemDtoSerializer implements PrimitiveSerializer<BaseItemDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.extraType != null) {
      ...
      yield serializers.serialize(
        object.extraType,
        specifiedType: const FullType(ExtraType),
      );
    }
    ...
    if (object.playAccess != null) {
      ...
      yield serializers.serialize(
        object.playAccess,
        specifiedType: const FullType(PlayAccess),
      );
    }
    ...
    if (object.collectionType != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(CollectionType),
      );
    }
    ...
    if (object.videoType != null) {
      ...
      yield serializers.serialize(
        object.videoType,
        specifiedType: const FullType(VideoType),
      );
    }
    ...
    if (object.isoType != null) {
      ...
      yield serializers.serialize(
        object.isoType,
        specifiedType: const FullType(IsoType),
      );
    }
    ...
    if (object.imageOrientation != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(ImageOrientation),
      );
    }
    ...
    if (object.audio != null) {
      ...
      yield serializers.serialize(
        object.audio,
        specifiedType: const FullType(ProgramAudio),
      );
    }
