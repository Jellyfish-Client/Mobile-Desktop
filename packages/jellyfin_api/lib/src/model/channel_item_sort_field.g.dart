...
const ChannelItemSortField _$channelitemsortfieldName =
    const ChannelItemSortField._('name_');
...
ChannelItemSortField _$valueOf(String name) {
  switch (name) {
    case 'name_':
      return _$channelitemsortfieldName;
...
class _$ChannelItemSortFieldMeta {
  ...
  ChannelItemSortField get name_ => _$channelitemsortfieldName;
