...
import 'package:jellyfin_api/src/api/activity_log_api.dart';
import 'package:jellyfin_api/src/api/api_key_api.dart';
import 'package:jellyfin_api/src/api/artists_api.dart';
...
import 'package:jellyfin_api/src/api/channels_api.dart';
import 'package:jellyfin_api/src/api/client_log_api.dart';
import 'package:jellyfin_api/src/api/collection_api.dart';
import 'package:jellyfin_api/src/api/configuration_api.dart';
import 'package:jellyfin_api/src/api/dashboard_api.dart';
import 'package:jellyfin_api/src/api/devices_api.dart';
import 'package:jellyfin_api/src/api/display_preferences_api.dart';
import 'package:jellyfin_api/src/api/dynamic_hls_api.dart';
import 'package:jellyfin_api/src/api/environment_api.dart';
import 'package:jellyfin_api/src/api/filter_api.dart';
import 'package:jellyfin_api/src/api/genres_api.dart';
import 'package:jellyfin_api/src/api/hls_segment_api.dart';
...
import 'package:jellyfin_api/src/api/item_refresh_api.dart';
import 'package:jellyfin_api/src/api/item_update_api.dart';
import 'package:jellyfin_api/src/api/items_api.dart';
...
import 'package:jellyfin_api/src/api/lyrics_api.dart';
import 'package:jellyfin_api/src/api/media_info_api.dart';
import 'package:jellyfin_api/src/api/media_segments_api.dart';
import 'package:jellyfin_api/src/api/movies_api.dart';
import 'package:jellyfin_api/src/api/music_genres_api.dart';
import 'package:jellyfin_api/src/api/package_api.dart';
import 'package:jellyfin_api/src/api/persons_api.dart';
import 'package:jellyfin_api/src/api/playlists_api.dart';
import 'package:jellyfin_api/src/api/playstate_api.dart';
import 'package:jellyfin_api/src/api/plugins_api.dart';
import 'package:jellyfin_api/src/api/quick_connect_api.dart';
import 'package:jellyfin_api/src/api/remote_image_api.dart';
import 'package:jellyfin_api/src/api/scheduled_tasks_api.dart';
...
import 'package:jellyfin_api/src/api/studios_api.dart';
import 'package:jellyfin_api/src/api/subtitle_api.dart';
import 'package:jellyfin_api/src/api/suggestions_api.dart';
import 'package:jellyfin_api/src/api/sync_play_api.dart';
import 'package:jellyfin_api/src/api/system_api.dart';
import 'package:jellyfin_api/src/api/time_sync_api.dart';
import 'package:jellyfin_api/src/api/tmdb_api.dart';
import 'package:jellyfin_api/src/api/trailers_api.dart';
import 'package:jellyfin_api/src/api/trickplay_api.dart';
import 'package:jellyfin_api/src/api/tv_shows_api.dart';
import 'package:jellyfin_api/src/api/universal_audio_api.dart';
import 'package:jellyfin_api/src/api/user_api.dart';
import 'package:jellyfin_api/src/api/user_library_api.dart';
import 'package:jellyfin_api/src/api/user_views_api.dart';
import 'package:jellyfin_api/src/api/video_attachments_api.dart';
import 'package:jellyfin_api/src/api/videos_api.dart';
import 'package:jellyfin_api/src/api/years_api.dart';
