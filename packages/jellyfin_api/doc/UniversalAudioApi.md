...
final api = JellyfinApi().getUniversalAudioApi();
...
final MediaStreamProtocol transcodingProtocol = ; // MediaStreamProtocol | Optional. The transcoding protocol.
 ...
 **transcodingProtocol** | [**MediaStreamProtocol**](.md)| Optional. The transcoding protocol. | [optional] 
