...
final api = JellyfinApi().getLibraryApi();
...
final api = JellyfinApi().getLibraryApi();
final CollectionType libraryContentType = ; // CollectionType | Library content type.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **libraryContentType** | [**CollectionType**](.md)| Library content type. | [optional] 
