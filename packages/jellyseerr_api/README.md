...
[*BlocklistApi*](doc/BlocklistApi.md) | [**blacklistGet**](doc/BlocklistApi.md#blacklistget) | **GET** /blacklist | Returns blocklisted items
[*BlocklistApi*](doc/BlocklistApi.md) | [**blacklistPost**](doc/BlocklistApi.md#blacklistpost) | **POST** /blacklist | Add media to blocklist
[*BlocklistApi*](doc/BlocklistApi.md) | [**blacklistTmdbIdDelete**](doc/BlocklistApi.md#blacklisttmdbiddelete) | **DELETE** /blacklist/{tmdbId} | Remove media from blocklist
[*BlocklistApi*](doc/BlocklistApi.md) | [**blacklistTmdbIdGet**](doc/BlocklistApi.md#blacklisttmdbidget) | **GET** /blacklist/{tmdbId} | Get media from blocklist
[*BlocklistApi*](doc/BlocklistApi.md) | [**blocklistCollectionCollectionIdDelete**](doc/BlocklistApi.md#blocklistcollectioncollectioniddelete) | **DELETE** /blocklist/collection/{collectionId} | Remove collection from blocklist
[*BlocklistApi*](doc/BlocklistApi.md) | [**blocklistCollectionCollectionIdPost**](doc/BlocklistApi.md#blocklistcollectioncollectionidpost) | **POST** /blocklist/collection/{collectionId} | Add collection to blocklist
[*BlocklistApi*](doc/BlocklistApi.md) | [**blocklistGet**](doc/BlocklistApi.md#blocklistget) | **GET** /blocklist | Returns blocklisted items
[*BlocklistApi*](doc/BlocklistApi.md) | [**blocklistPost**](doc/BlocklistApi.md#blocklistpost) | **POST** /blocklist | Add media to blocklist
[*BlocklistApi*](doc/BlocklistApi.md) | [**blocklistTmdbIdDelete**](doc/BlocklistApi.md#blocklisttmdbiddelete) | **DELETE** /blocklist/{tmdbId} | Remove media from blocklist
[*BlocklistApi*](doc/BlocklistApi.md) | [**blocklistTmdbIdGet**](doc/BlocklistApi.md#blocklisttmdbidget) | **GET** /blocklist/{tmdbId} | Get media from blocklist
...
[*OtherApi*](doc/OtherApi.md) | [**certificationsMovieGet**](doc/OtherApi.md#certificationsmovieget) | **GET** /certifications/movie | Get movie certifications
[*OtherApi*](doc/OtherApi.md) | [**certificationsTvGet**](doc/OtherApi.md#certificationstvget) | **GET** /certifications/tv | Get TV certifications
...
[*OverrideruleApi*](doc/OverrideruleApi.md) | [**overrideRuleGet**](doc/OverrideruleApi.md#overrideruleget) | **GET** /overrideRule | Get override rules
[*OverrideruleApi*](doc/OverrideruleApi.md) | [**overrideRulePost**](doc/OverrideruleApi.md#overriderulepost) | **POST** /overrideRule | Create override rule
[*OverrideruleApi*](doc/OverrideruleApi.md) | [**overrideRuleRuleIdDelete**](doc/OverrideruleApi.md#overrideruleruleiddelete) | **DELETE** /overrideRule/{ruleId} | Delete override rule by ID
[*OverrideruleApi*](doc/OverrideruleApi.md) | [**overrideRuleRuleIdPut**](doc/OverrideruleApi.md#overrideruleruleidput) | **PUT** /overrideRule/{ruleId} | Update override rule
...
[*PublicApi*](doc/PublicApi.md) | [**statusGet**](doc/PublicApi.md#statusget) | **GET** /status | Get Seerr status
...
[*SettingsApi*](doc/SettingsApi.md) | [**settingsCacheDnsDnsEntryFlushPost**](doc/SettingsApi.md#settingscachednsdnsentryflushpost) | **POST** /settings/cache/dns/{dnsEntry}/flush | Flush a specific DNS cache entry
...
[*SettingsApi*](doc/SettingsApi.md) | [**settingsMetadatasGet**](doc/SettingsApi.md#settingsmetadatasget) | **GET** /settings/metadatas | Get Metadata settings
[*SettingsApi*](doc/SettingsApi.md) | [**settingsMetadatasPut**](doc/SettingsApi.md#settingsmetadatasput) | **PUT** /settings/metadatas | Update Metadata settings
[*SettingsApi*](doc/SettingsApi.md) | [**settingsMetadatasTestPost**](doc/SettingsApi.md#settingsmetadatastestpost) | **POST** /settings/metadatas/test | Test Provider configuration
[*SettingsApi*](doc/SettingsApi.md) | [**settingsNetworkGet**](doc/SettingsApi.md#settingsnetworkget) | **GET** /settings/network | Get network settings
[*SettingsApi*](doc/SettingsApi.md) | [**settingsNetworkPost**](doc/SettingsApi.md#settingsnetworkpost) | **POST** /settings/network | Update network settings
...
[*SettingsApi*](doc/SettingsApi.md) | [**settingsNotificationsNtfyGet**](doc/SettingsApi.md#settingsnotificationsntfyget) | **GET** /settings/notifications/ntfy | Get ntfy.sh notification settings
[*SettingsApi*](doc/SettingsApi.md) | [**settingsNotificationsNtfyPost**](doc/SettingsApi.md#settingsnotificationsntfypost) | **POST** /settings/notifications/ntfy | Update ntfy.sh notification settings
[*SettingsApi*](doc/SettingsApi.md) | [**settingsNotificationsNtfyTestPost**](doc/SettingsApi.md#settingsnotificationsntfytestpost) | **POST** /settings/notifications/ntfy/test | Test ntfy.sh settings
...
[*TvApi*](doc/TvApi.md) | [**tvTvIdSeasonSeasonNumberGet**](doc/TvApi.md#tvtvidseasonseasonnumberget) | **GET** /tv/{tvId}/season/{seasonNumber} | Get season details and episode list
...
[*UsersApi*](doc/UsersApi.md) | [**userUserIdSettingsLinkedAccountsJellyfinDelete**](doc/UsersApi.md#useruseridsettingslinkedaccountsjellyfindelete) | **DELETE** /user/{userId}/settings/linked-accounts/jellyfin | Remove the linked Jellyfin account for a user
[*UsersApi*](doc/UsersApi.md) | [**userUserIdSettingsLinkedAccountsJellyfinPost**](doc/UsersApi.md#useruseridsettingslinkedaccountsjellyfinpost) | **POST** /user/{userId}/settings/linked-accounts/jellyfin | Link the provided Jellyfin account to the current user
[*UsersApi*](doc/UsersApi.md) | [**userUserIdSettingsLinkedAccountsPlexDelete**](doc/UsersApi.md#useruseridsettingslinkedaccountsplexdelete) | **DELETE** /user/{userId}/settings/linked-accounts/plex | Remove the linked Plex account for a user
[*UsersApi*](doc/UsersApi.md) | [**userUserIdSettingsLinkedAccountsPlexPost**](doc/UsersApi.md#useruseridsettingslinkedaccountsplexpost) | **POST** /user/{userId}/settings/linked-accounts/plex | Link the provided Plex account to the current user
...
## Documentation For Models
 ...
 - [Blocklist](doc/Blocklist.md)
 - [BlocklistGet200Response](doc/BlocklistGet200Response.md)
 - [BlocklistGet200ResponseResultsInner](doc/BlocklistGet200ResponseResultsInner.md)
 - [Cast](doc/Cast.md)
 - [Certification](doc/Certification.md)
 - [CertificationResponse](doc/CertificationResponse.md)
 - [CertificationsMovieGet500Response](doc/CertificationsMovieGet500Response.md)
 - [CertificationsTvGet500Response](doc/CertificationsTvGet500Response.md)
 ...
 - [KeywordKeywordIdGet500Response](doc/KeywordKeywordIdGet500Response.md)
 ...
 - [MetadataSettings](doc/MetadataSettings.md)
 - [MetadataSettingsSettings](doc/MetadataSettingsSettings.md)
 ...
 - [NetworkSettingsDnsCache](doc/NetworkSettingsDnsCache.md)
 - [NetworkSettingsProxy](doc/NetworkSettingsProxy.md)
 ...
 - [NtfySettings](doc/NtfySettings.md)
 - [NtfySettingsOptions](doc/NtfySettingsOptions.md)
 - [OverrideRule](doc/OverrideRule.md)
 ...
 - [SettingsCacheGet200ResponseDnsCache](doc/SettingsCacheGet200ResponseDnsCache.md)
 - [SettingsCacheGet200ResponseDnsCacheEntriesValue](doc/SettingsCacheGet200ResponseDnsCacheEntriesValue.md)
 - [SettingsCacheGet200ResponseDnsCacheEntriesValueAddresses](doc/SettingsCacheGet200ResponseDnsCacheEntriesValueAddresses.md)
 - [SettingsCacheGet200ResponseDnsCacheStats](doc/SettingsCacheGet200ResponseDnsCacheStats.md)
 ...
 - [SettingsMetadatasTestPost200Response](doc/SettingsMetadatasTestPost200Response.md)
 - [SettingsMetadatasTestPostRequest](doc/SettingsMetadatasTestPostRequest.md)
 ...
 - [UserUserIdSettingsLinkedAccountsJellyfinPostRequest](doc/UserUserIdSettingsLinkedAccountsJellyfinPostRequest.md)
