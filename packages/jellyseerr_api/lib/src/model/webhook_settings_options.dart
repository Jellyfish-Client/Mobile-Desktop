...
abstract class WebhookSettingsOptions
  ...
  @BuiltValueField(wireName: r'supportVariables')
  bool? get supportVariables;
...
class _$WebhookSettingsOptionsSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.supportVariables != null) {
      yield r'supportVariables';
      yield serializers.serialize(
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'jsonPayload':
          ...
          break;
        case r'supportVariables':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.supportVariables = valueDes;
          break;
        default:
          unhandled.add(key);
          unhandled.add(value);
