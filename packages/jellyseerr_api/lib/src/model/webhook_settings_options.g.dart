...
class _$WebhookSettingsOptions extends WebhookSettingsOptions {
  ...
  bool operator ==(Object other) {
    ...
    return other is WebhookSettingsOptions &&
        ...
        supportVariables == other.supportVariables;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, supportVariables.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'WebhookSettingsOptions')
          ...
          ..add('supportVariables', supportVariables))
        .toString();
  }
}
...
class WebhookSettingsOptionsBuilder
  ...
  bool? _supportVariables;
  bool? get supportVariables => _$this._supportVariables;
  set supportVariables(bool? supportVariables) =>
      _$this._supportVariables = supportVariables;
  ...
  WebhookSettingsOptionsBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _supportVariables = $v.supportVariables;
      _$v = null;
    }
    return this;
  }
