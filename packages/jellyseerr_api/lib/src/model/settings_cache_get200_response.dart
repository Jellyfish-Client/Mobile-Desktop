...
abstract class SettingsCacheGet200Response
  ...
  SettingsCacheGet200ResponseDnsCache? get dnsCache;
...
class _$SettingsCacheGet200ResponseSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.dnsCache != null) {
      ...
      yield serializers.serialize(
        object.dnsCache,
        specifiedType: const FullType(SettingsCacheGet200ResponseDnsCache),
      );
    }
      ...
      switch (key) {
        ...
        case r'dnsCache':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(SettingsCacheGet200ResponseDnsCache),
          ) as SettingsCacheGet200ResponseDnsCache;
