...
final api = JellyseerrApi().getSearchApi();
...
final String excludeKeywords = 3,4; // String | Comma-separated list of keyword IDs to exclude from results
final String sortBy = popularity.desc; // String | 
final String primaryReleaseDateGte = 2022-01-01T00:00:00.000Z; // String | 
final String primaryReleaseDateLte = 2023-01-01T00:00:00.000Z; // String | 
...
try {
    final response = api.discoverMoviesGet(page, language, genre, studio, keywords, excludeKeywords, sortBy, primaryReleaseDateGte, primaryReleaseDateLte, withRuntimeGte, withRuntimeLte, voteAverageGte, voteAverageLte, voteCountGte, voteCountLte, watchRegion, watchProviders, certification, certificationGte, certificationLte, certificationCountry, certificationMode);
    print(response);
} catch on DioException (e) {
 ...
 **excludeKeywords** | **String**| Comma-separated list of keyword IDs to exclude from results | [optional] 
...
# **discoverTrendingGet**
> SearchGet200Response discoverTrendingGet(page, language, mediaType, timeWindow)
...
final String timeWindow = timeWindow_example; // String | 

try {
    final response = api.discoverTrendingGet(page, language, mediaType, timeWindow);
    print(response);
} catch on DioException (e) {
 ...
 **timeWindow** | **String**|  | [optional] [default to 'day']
...
final String excludeKeywords = 3,4; // String | Comma-separated list of keyword IDs to exclude from results
final String sortBy = popularity.desc; // String | 
final String firstAirDateGte = 2022-01-01T00:00:00.000Z; // String | 
final String firstAirDateLte = 2023-01-01T00:00:00.000Z; // String | 
final num withRuntimeGte = 60; // num | 
final num withRuntimeLte = 120; // num | 
final num voteAverageGte = 7; // num | 
final num voteAverageLte = 10; // num | 
...
try {
    final response = api.discoverTvGet(page, language, genre, network, keywords, excludeKeywords, sortBy, firstAirDateGte, firstAirDateLte, withRuntimeGte, withRuntimeLte, voteAverageGte, voteAverageLte, voteCountGte, voteCountLte, watchRegion, watchProviders, status, certification, certificationGte, certificationLte, certificationCountry, certificationMode);
    print(response);
} catch on DioException (e) {
