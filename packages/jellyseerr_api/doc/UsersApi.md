...
final api = JellyseerrApi().getUsersApi();
...
# **userGet**
> UserGet200Response userGet(take, skip, sort, sortDirection, q, includeIds)
...
final String sortDirection = sortDirection_example; // String | Sort direction. When omitted, the server chooses the direction per sort field (e.g. displayname defaults to asc, requests/updated to desc). 
final String q = q_example; // String | 
final String includeIds = includeIds_example; // String | 

try {
    final response = api.userGet(take, skip, sort, sortDirection, q, includeIds);
    print(response);
} catch on DioException (e) {
 ...
 **sortDirection** | **String**| Sort direction. When omitted, the server chooses the direction per sort field (e.g. displayname defaults to asc, requests/updated to desc).  | [optional] 
 **q** | **String**|  | [optional] 
