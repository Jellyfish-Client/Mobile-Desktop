# jellyseerr_api.api.WatchlistApi
...
final api = JellyseerrApi().getWatchlistApi();
...
> watchlistTmdbIdDelete(tmdbId, mediaType)
...
try {
    api.watchlistTmdbIdDelete(tmdbId, mediaType);
} catch on DioException (e) {
