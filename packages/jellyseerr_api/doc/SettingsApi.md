# jellyseerr_api.api.SettingsApi
...
final api = JellyseerrApi().getSettingsApi();
...
final api = JellyseerrApi().getSettingsApi();
final String dnsEntry = dnsEntry_example; // String | 

try {
    api.settingsCacheDnsDnsEntryFlushPost(dnsEntry);
} catch on DioException (e) {
    print('Exception when calling SettingsApi->settingsCacheDnsDnsEntryFlushPost: $e\n');
}
```
...
try {
    final response = api.settingsMetadatasGet();
    print(response);
} catch on DioException (e) {
    print('Exception when calling SettingsApi->settingsMetadatasGet: $e\n');
}
```
...
final api = JellyseerrApi().getSettingsApi();
final MetadataSettings metadataSettings = ; // MetadataSettings | 

try {
    final response = api.settingsMetadatasPut(metadataSettings);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SettingsApi->settingsMetadatasPut: $e\n');
}
```
...
final api = JellyseerrApi().getSettingsApi();
final SettingsMetadatasTestPostRequest settingsMetadatasTestPostRequest = ; // SettingsMetadatasTestPostRequest | 

try {
    final response = api.settingsMetadatasTestPost(settingsMetadatasTestPostRequest);
    print(response);
} catch on DioException (e) {
    print('Exception when calling SettingsApi->settingsMetadatasTestPost: $e\n');
}
```
