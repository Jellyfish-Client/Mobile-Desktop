...
/// tests for UsersApi
void main() {
  final instance = JellyseerrApi().getUsersApi();
  ...
  group(UsersApi, () {
    ...
    //
    //Future<UserGet200Response> userGet({ num take, num skip, String sort, String sortDirection, String q, String includeIds }) async
