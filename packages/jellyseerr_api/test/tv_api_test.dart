...
/// tests for TvApi
void main() {
  final instance = JellyseerrApi().getTvApi();
  ...
  group(TvApi, () {
    ...
    //
    //Future<Season> tvTvIdSeasonSeasonNumberGet(num tvId, num seasonNumber, { String language }) async
    test('test tvTvIdSeasonSeasonNumberGet', () async {
      // TODO
    });
