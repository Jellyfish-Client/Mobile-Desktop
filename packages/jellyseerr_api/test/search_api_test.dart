...
/// tests for SearchApi
void main() {
  final instance = JellyseerrApi().getSearchApi();
  ...
  group(SearchApi, () {
    ...
    //
    //Future<SearchGet200Response> discoverTrendingGet({ num page, String language, String mediaType, String timeWindow }) async
    ...
    //
    //Future<DiscoverTvGet200Response> discoverTvGet({ num page, String language, String genre, num network, String keywords, String excludeKeywords, String sortBy, String firstAirDateGte, String firstAirDateLte, num withRuntimeGte, num withRuntimeLte, num voteAverageGte, num voteAverageLte, num voteCountGte, num voteCountLte, String watchRegion, String watchProviders, String status, String certification, String certificationGte, String certificationLte, String certificationCountry, String certificationMode }) async
